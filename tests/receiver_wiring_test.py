...
# _PORT_DELETIONS: tests not copied from basic_wiring_test.py because
# they test 1.x-only surface (property setters, float properties, subclass
# hierarchy, factory functions, capability raises, stepper warn-and-ignore)
# that has been replaced by structural capability (WP2/WP3/WP4):
#
# TestSupportedModels - factories/exports port in Task 5's public_surface_test.py
# TestReceiverClassHierarchy - hierarchy replaced by WP2 dialect data + WP4 matrix
# TestMP40Receiver through TestP300Receiver - subclass init replaced by ModelConfig
# TestReadmeCodeExamples - README references old API (updated separately)
# TestConvertDecibel - convert_decibel moved to receiver.py (tested via receiver_test.py)
# TestReceiverCreation - factory path (async_create_receiver) ports in Task 5
# TestReceiverBasicFunctionality - async_create_receiver, old API
# TestPowerControl - power_on setter (bump PR)
# TestVolumeAndMute - volume/muted as floats, setters
# TestTrimControls - trim property setters/reads replaced by trims[Trim.X]
# TestSourcesAndSoundModes - source/sound_mode property setters
# TestZoneBFunctionality - zone_b_volume as float, setters
# TestAvailableInputAndStreamTypeTables - local-from-device imports
# TestStreamingAndVideoInfo - old streaming property paths
# TestRoomPerfectAndVoicing - property setters
# TestNotificationCallbacks - register_notification_callback (shimmed, tested by compat_test)
# TestConnectionManagement - async_connect shimmed
# TestZoneBGating - zone_b property setters
# TestSetupCommandPacing - async_connect path
# TestVolumeAndTrimStepCommandShapePerFamily - subclass hierarchy
# TestTrimBassTrebleScale - 1.x trim API
# TestVolumeRangeAndValidation - volume_range property + setter validation
# TestMethodSetters - set_volume/set_trim_bass (shimmed, tested by compat_test)
# TestExceptionHandling - _require_capability (raises replaced by structural None)
# TestTdaiStateEncoding - TDAI-specific model delegates
# TestTdaiSourceName - TDAI-specific callback wiring
# TestTdai2170FixedLists - TDAI-2170-specific fixed-list callbacks
# TestMessageFraming - low-level protocol
# TestTdaiRoomPerfectAndVoicingNames - TDAI-specific callback wiring
# TestMessageParameterParsing - low-level protocol
# TestReadmeCapabilityMatrix - README references old API
# TestPongDetectionDefensive - api-level (unchanged)
# TestKeepaliveIsGenericAndUniversal - model-level delegates
# TestNewMPCommands - MP-specific
...
# PORT-DELETION: TestSupportedModels - 1.x-only (list(LyngdorfModel))
class _PORT_DELETION_TestSupportedModels:
...
# PORT-DELETION: TestReadmeCodeExamples - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestReadmeCodeExamples:
...
# PORT-DELETION: TestConvertDecibel - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestConvertDecibel:
...
# PORT-DELETION: TestMP40Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestMP40Receiver:
    ...
    async def test_mp40_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_40, "192.168.1.1")
    ...
    async def test_mp40_shared_commands_with_mp60(self):
        ...
        mp40 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_40, "192.168.1.1")
        mp60 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_60, "192.168.1.1")
...
# PORT-DELETION: TestMP50Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestMP50Receiver:
    ...
    async def test_mp50_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_50, "192.168.1.1")
    ...
    async def test_mp50_shared_commands_with_mp60(self):
        ...
        mp50 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_50, "192.168.1.1")
        mp60 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_60, "192.168.1.1")
...
# PORT-DELETION: TestMP60Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestMP60Receiver:
    ...
    async def test_mp60_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_60, "192.168.1.1")
...
# PORT-DELETION: TestTDAI1120Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestTDAI1120Receiver:
    ...
    def test_tdai1120_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1")
...
# PORT-DELETION: TestTDAI2170Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestTDAI2170Receiver:
    ...
    def test_tdai2170_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_2170, "192.168.1.1")
    ...
    def test_tdai2170_shares_basic_commands_with_tdai1120(self):
        ...
        tdai1120 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1")
        tdai2170 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_2170, "192.168.1.1")
...
# PORT-DELETION: TestTDAI3400Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestTDAI3400Receiver:
    ...
    def test_tdai3400_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_3400, "192.168.1.1")
    ...
    def test_tdai3400_shares_tdai1120_protocol(self):
        ...
        tdai1120 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1")
        tdai3400 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_3400, "192.168.1.1")
...
# PORT-DELETION: TestTDAI2210Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestTDAI2210Receiver:
    ...
    def test_tdai2210_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_2210, "192.168.1.1")
    ...
    def test_tdai2210_shares_tdai1120_protocol(self):
        ...
        tdai1120 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1")
        tdai2210 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_2210, "192.168.1.1")
...
# PORT-DELETION: TestNewMPCommands - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestNewMPCommands:
    ...
    def test_tdai_has_step_commands(self):
        ...
        tdai = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1")
...
# PORT-DELETION: TestP100Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestP100Receiver:
    ...
    async def test_p100_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.P_100, "192.168.1.1")
...
# PORT-DELETION: TestP200Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestP200Receiver:
    ...
    async def test_p200_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.P_200, "192.168.1.1")
...
# PORT-DELETION: TestP300Receiver - subclass hierarchy deleted (replaced by WP4 test_components_match_model_config + WP2 dialect data)
class _PORT_DELETION_TestP300Receiver:
    ...
    async def test_p300_receiver_initialization(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.P_300, "192.168.1.1")
    ...
    async def test_p300_shares_commands_with_p200(self):
        ...
        p200 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.P_200, "192.168.1.1")
        p300 = LyngdorfReceiver(FAKE_IP, LyngdorfModel.P_300, "192.168.1.1")
...
# PORT-DELETION: TestReceiverCreation - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestReceiverCreation:
...
# PORT-DELETION: TestReceiverBasicFunctionality - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestReceiverBasicFunctionality:
    ...
    async def test_receiver_name_property(self):
        ...
        def test_function(client: LyngdorfReceiver):
...
# PORT-DELETION: TestPowerControl - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestPowerControl:
    ...
    async def test_power_control_commands(self):
        ...
        def client_functions(client: LyngdorfReceiver):
            client.power_on = True
            client.power_on = False
            client.zone_b_power_on = True
            client.zone_b_power_on = False

        def assertion_function(client: LyngdorfReceiver, commandsSent: list):
            assert [
                "!POWERONMAIN",
                "!POWEROFFMAIN",
                "!POWERONZONE2",
...
# PORT-DELETION: TestVolumeAndMute - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestVolumeAndMute:
    ...
    def test_max_volume_is_none_before_any_reply(self):
        ...
        assert (
            LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_60, "192.168.1.1").max_volume
            is None
        )
        assert (
            LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120, "192.168.1.1").max_volume
            is None
        )
...
# PORT-DELETION: TestTrimControls - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTrimControls:
    ...
    async def test_lipsync_range_reading(self):
        ...
        def test_function_custom_range(client: LyngdorfReceiver):
    ...
    def test_lipsync_range_default_before_any_reply(self):
        ...
        assert LyngdorfReceiver(
            FAKE_IP, LyngdorfModel.MP_60
        ).lipsync_range == NumericRange(min=0.0, max=500.0, step=1.0)
        assert LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120).lipsync_range is None
    ...
    def test_trim_setters_reject_unsupported_setting_on_tdai(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120)
        receiver._api._protocol = mock.Mock()
    ...
    def test_trim_setters_reject_any_trim_on_tdai_2170(self):
        ...
        receiver = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_2170)
        receiver._api._protocol = mock.Mock()
...
# PORT-DELETION: TestSourcesAndSoundModes - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestSourcesAndSoundModes:
    ...
    async def test_source_and_sound_mode_commands(self):
        ...
        def test_function(client: LyngdorfReceiver, commandsSent: list):
...
# PORT-DELETION: TestZoneBFunctionality - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestZoneBFunctionality:
...
# PORT-DELETION: TestAudioVideoInputs - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestAudioVideoInputs:
...
# PORT-DELETION: TestAvailableInputAndStreamTypeTables - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestAvailableInputAndStreamTypeTables:
...
# PORT-DELETION: TestStreamingAndVideoInfo - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestStreamingAndVideoInfo:
...
# PORT-DELETION: TestRoomPerfectAndVoicing - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestRoomPerfectAndVoicing:
...
# PORT-DELETION: TestNotificationCallbacks - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestNotificationCallbacks:
    ...
    async def test_notification_callbacks(self):
        ...
        def before_connect_function(client: LyngdorfReceiver):
...
# PORT-DELETION: TestConnectionManagement - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestConnectionManagement:
...
# PORT-DELETION: TestZoneBGating - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestZoneBGating:
...
# PORT-DELETION: TestSetupCommandPacing - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestSetupCommandPacing:
...
# PORT-DELETION: TestPongDetectionDefensive - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestPongDetectionDefensive:
...
# PORT-DELETION: TestKeepaliveIsGenericAndUniversal - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestKeepaliveIsGenericAndUniversal:
...
# PORT-DELETION: TestVolumeAndTrimStepCommandShapePerFamily - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestVolumeAndTrimStepCommandShapePerFamily:
...
# PORT-DELETION: TestTrimBassTrebleScale - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTrimBassTrebleScale:
...
# PORT-DELETION: TestVolumeRangeAndValidation - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestVolumeRangeAndValidation:
    ...
    def test_receiver_volume_range_is_static_and_ignores_max_volume(self):
        ...
        tdai_expected = NumericRange(min=-99.9, max=12.0, step=0.1)
        tdai = LyngdorfReceiver(FAKE_IP, LyngdorfModel.TDAI_1120)
    ...
    def test_volume_setter_sends_value_above_tdai_ceiling_unchanged(self):
        ...
        mp = LyngdorfReceiver(FAKE_IP, LyngdorfModel.MP_60)
...
# PORT-DELETION: TestMethodSetters - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestMethodSetters:
...
# PORT-DELETION: TestReceiverClassHierarchy - 1.x hierarchy replaced by WP2 dialect + WP4 matrix
class _PORT_DELETION_TestReceiverClassHierarchy:
...
# PORT-DELETION: TestExceptionHandling - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestExceptionHandling:
...
# PORT-DELETION: TestTdaiStateEncoding - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTdaiStateEncoding:
...
# PORT-DELETION: TestTdaiSourceName - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTdaiSourceName:
...
# PORT-DELETION: TestTdai2170FixedLists - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTdai2170FixedLists:
...
# PORT-DELETION: TestMessageFraming - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestMessageFraming:
...
# PORT-DELETION: TestTdaiRoomPerfectAndVoicingNames - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestTdaiRoomPerfectAndVoicingNames:
    ...
    async def test_room_perfect_positions_populate_and_current_is_set(self):
        ...
        def check(client: LyngdorfReceiver):
...
# PORT-DELETION: TestMessageParameterParsing - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestMessageParameterParsing:
...
# PORT-DELETION: TestReadmeCapabilityMatrix - uses 1.x surface (setters, floats, property shapes) replaced by new API
class _PORT_DELETION_TestReadmeCapabilityMatrix:
